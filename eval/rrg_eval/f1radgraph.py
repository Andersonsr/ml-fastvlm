...
class F1RadGraphv2(F1RadGraph):
    def __init__(
        ...
        super().__init__(reward_level, model_type='radgraph', )
        assert reward_level in ["simple", "partial", "complete", "all"]

    def _download_radgraph(self):
        print("_____Downloading", os.path.join(CACHE_DIR, "radgraph.tar.gz"))
...
if __name__ == '__main__':
    ...
    m_og = F1RadGraph(reward_level='partial', model_type='radgraph')
