...
if __name__ == '__main__':
    filename = 'E:\\datasets\\mimic\\chat_dev_MIMIC_CXR_all_gpt4extract_rulebased_v1.json'
    output_dir = 'E:\\datasets\\mimic\\preprocess\\resize_1024_val'
    ...
    with open(os.path.join(os.path.dirname(output_dir), 'dev_split.json'), 'w') as outfile:
