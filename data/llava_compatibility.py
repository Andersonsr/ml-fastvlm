...
if __name__ == '__main__':
    filename = "E:\\datasets\\mimic\\preprocess\\train_split_filter.json"
    ...
    json.dump(new_data, open('E:\\datasets\\mimic\\preprocess\\train_split_filter_llava.json', 'w'), indent=2)
